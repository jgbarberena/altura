/**
 * programa-san-fermin-embed.js
 *
 * Versión standalone de programa-san-fermin.js para uso en iframe.
 * Diferencias respecto al original:
 * - EVENT_PAGES usa URLs absolutas (href e img) para funcionar desde dominios externos.
 * - Los enlaces del panel abren en nueva pestaña (target="_blank").
 */
...
/* ── PÁGINAS PROPIAS ─────────────────────────────────────── */
const EVENT_PAGES = {
  encierro:            { href:'https://www.experienciasanfermin.com/experiencias/encierro/',    label:'Ver experiencia del encierro',    img:'https://www.experienciasanfermin.com/img/cards/card-encierro-balcon-premium_mobile.jpg' },
  chupinazo:           { href:'https://www.experienciasanfermin.com/experiencias/chupinazo/',   label:'Ver experiencia del chupinazo',   img:'https://www.experienciasanfermin.com/img/cards/card-chupinazo-san-fermin-premium_mobile.jpg' },
  procesion:           { href:'https://www.experienciasanfermin.com/experiencias/procesion/',   label:'Ver experiencia de la procesión', img:'https://www.experienciasanfermin.com/img/cards/card-procesion-san-fermin-pamplona_mobile.jpg' },
  'despedida-gigantes':{ href:'https://www.experienciasanfermin.com/experiencias/gigantes/',    label:'Ver experiencia de los gigantes', img:'https://www.experienciasanfermin.com/img/cards/card-despedida-gigantes-balcon_mobile.jpg' },
  'pobre-de-mi':       { href:'https://www.experienciasanfermin.com/experiencias/pobre-de-mi/',label:'Ver experiencia del Pobre de Mí', img:'https://www.experienciasanfermin.com/img/cards/card-pobredemi-balcon-premium_mobile.jpg' },
};
...
function initMapaSanFermin() {
  ...
  function buildTooltipHTML(loc, matchedEvents) {
    ...
    const linkHtml = page
      ? `<a class="sfp-link" href="${page.href}" target="_blank" rel="noopener">${page.label} →</a>` : '';
